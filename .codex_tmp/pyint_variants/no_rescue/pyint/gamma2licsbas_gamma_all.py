...
#    ifgList = ifgList0[:,0]
    ...
    err_txt = scratchDir + '/' + projectName + '/gamma2licsbas_gamma_all.err'
    ...
    for i in range(len(ifgList)):
        ...
        cmd0 = ['gamma2licsbas_gamma.py',projectName, ifgList[i]]
        data0 = [cmd0,err_txt]
        geo_file0 = GEOC + '/' + ifgList[i] + '/'+ ifgList[i] + '.geo.unw.tif'
