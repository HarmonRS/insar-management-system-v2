...
def main(argv):
    ...
    unwFile = projectDir + '/ifgrams/*/diff_filt_*.unw'  # considering geocode unw file
    corFile = projectDir + '/ifgrams/*/diff_filt_*rlks.cor'
    #corFile = projectDir + '/ifgrams/*/filt_*.cor'
    print(unwFile)
