...
if ($#argv != 7) then
    echo ""
    echo "Usage: single_GACOS_correction.csh master_ztd master_ztd.rsc slave_ztd slave_ztd.rsc los.grd reference_point incidence_angle" 
    echo	""
...
gmt grdsample -R"date1_ztd.grd" date2_ztd.grd -I3s  -Gtmp.grd
mv tmp.grd date2_ztd.grd
#TIME DIFFERENCE
...
#gmt grd2xyz zpddm.grd >tmp
#gmt xyz2grd -R$xmin/$xmax/$ymin/$ymax -I$xinc/$yinc  tmp -Gresample_zpddm.grd 
gmt grdsample zpddm.grd -Gresample_zpddm.grd  -R$5 -I$xinc/$yinc
...
gmt grdmath resample_zpddm.grd $wavelength DIV -4 MUL $pi MUL = resample_zpddm_phs.grd
#cp resample_zpddm.grd resample_zpddm_phs.grd
#REFERENCE POINT
...
gmt grdmath phase_GACOS_corrected_phs.grd $wavelength MUL -4 DIV $pi DIV = phase_GACOS_corrected_los.grd
gmt grdmath phase_GACOS_corrected_phs_detrended.grd $wavelength MUL -4 DIV $pi DIV = phase_GACOS_corrected_los_detrended.grd
