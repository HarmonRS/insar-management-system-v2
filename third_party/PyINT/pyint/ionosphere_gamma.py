...
#########################################################
 ...
 ################## interferometry #####################   
    ...
    off_high = workDir + '/' +  Pair +'_' + rlks + 'rlks.high.off'   
  ...
  ######################################################
    ...
    call_str = 'cpx_to_real ' + diff_low + ' ' + diff_low_phase + ' ' + nWidth + ' 4'
    os.system(call_str)
   ...
   #call_str = 'image_stat ' + hl_diff4_phase + ' ' + nWidth + ' ' + nWidth_half + ' 200 200 ' + image_report
    call_str = 'image_stat ' + hl_diff4_phase + ' ' + nWidth + ' 0 0 ' + ' 200 200 ' + image_report
    os.system(call_str)
